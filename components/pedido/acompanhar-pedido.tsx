...
type Pedido = { cliente_nome: string; status: string; total: number; created_at: string; tipo_atendimento: string; codigo_retirada: string; empresas: { nome: string; tempo_entrega_minutos: number } | { nome: string; tempo_entrega_minutos: number }[] | null };
